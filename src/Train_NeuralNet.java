...
public class Train_NeuralNet implements NeuralNetListener,Serializable
{
    ...
    private int totalEpoches=20000;
    private double leaningRate=0.9;
    ...
    public static void main(String args[])
    {
        ...
        Train_NeuralNet xor = new Train_NeuralNet(2,1,"src/multipleLinearRegression/trainData.txt","output.txt","network.net");
